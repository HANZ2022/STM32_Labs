...
#include <stdio.h>
#include "main.h"  // STM32 generated header files
#include "User/main_user.h"  // User generated header files
#include "User/util.h"

#include "FreeRTOS.h"  // Required FreeRTOS header files
#include "task.h"
#include "timers.h"
...
void WhiteLEDTimerCallback(TimerHandle_t xTimer) {
...
void main_user() {
    ...
    xTimers[1] = xTimerCreate("Timer2", 100, pdTRUE, (void *) 0, WhiteLEDTimerCallback);
