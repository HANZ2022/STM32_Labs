...
enum SensorId_t {None, Controller, PH, Depth, Temperature, Oxygen};
enum AckTypes{RemoteSensingPlatformReset, PHSensorEnable,
	DepthSensorEnable, TemperatureSensorEnable,OxygenSensorEnable};
